...
if (isActionAccessible($guid, $connection2, "/modules/Policies/policies_manage.php")==FALSE) {
		...
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
			...
			<tr>
				<td colspan=2 class="right">
					<input type="hidden" name="q" value="/modules/<?php print $_SESSION[$guid]["module"] ?>/policies_manage.php">
	...
	print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/Policies/policies_manage_add.php&search=$search'><img title='New' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.png'/></a>" ;
	print "</div>" ;
